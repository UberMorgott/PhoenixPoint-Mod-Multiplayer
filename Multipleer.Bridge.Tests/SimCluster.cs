...
namespace Multipleer.Bridge.Tests
{
    ...
    /// real <see cref="Multipleer.Network.MessageLayer.NetworkMessage"/> packets through the REAL
    ...
    public sealed class SimCluster : IDisposable
    {
        ...
        private void WireRosterByHand()
        {
            foreach (var c in Clients)
            {
                ...
                Multipleer.Validation.PermissionManager.SetPermission(
                    c.PlayerGuid, Multipleer.Validation.CampaignPermission.FullCommander, true);
