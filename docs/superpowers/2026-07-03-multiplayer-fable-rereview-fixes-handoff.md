# Multiplayer session handoff — 2026-07-03 (Fable re-review + fixes)
...
- `D:\Steam\steamapps\common\Phoenix Point\Mods\Multiplayer\Multiplayer.dll` — SHA256 `15f9a08e91fccfad35b69467ebd0c46448ae2eff17574e46299998b368a22e3a`, 608768 B, 2026-07-03 00:43:40.

## In-game VERIFIED this session (run 00:27; roles: `multiplayer.log` = HOST that run)
...
2. `ace79ae` multi-choice: client choice click closes host modal (`TryHostNativeResolve` functional for the FIRST TIME ever; if it fails now, host log `[Multiplayer] TryHostNativeResolve guard=…` names the exact guard — paging guard next suspect).
