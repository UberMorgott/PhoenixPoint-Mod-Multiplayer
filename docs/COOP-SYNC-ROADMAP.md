...
- **NEXT ACTIONS (resume here):**
  ...
  3. **Inc4 S3 sim-freeze default-ON** — DONE (2026-07-05): `ClientSimFreeze.Enabled=true` committed as the permanent default (S1+S2 gates passed). NEXT is S4 (retire the §5 collapse set, one gate per commit, each in-game-gated) — NOT yet started
