...
# Updated deliberately 2026-08-15: L516 ADDED (an off-screen strip never vouches for its rows -- the
...
$expectedRegistrationDigest = 'a266880416118cdda8b542f0a3f71dad93f62082b6f659069b03f8e4ac19f60f'
