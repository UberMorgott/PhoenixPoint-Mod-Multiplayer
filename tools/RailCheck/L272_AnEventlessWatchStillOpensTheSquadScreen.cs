...
namespace RailCheck
{
    ...
    internal static class L272_AnEventlessWatchStillOpensTheSquadScreen
    {
        ...
        internal static IEnumerable<string> Check()
        {
            ...
            if (!Program.CalleeSequence(step).Any(c => c != null && c.Name == "LaunchMission"))
                yield return "L272 arrival-term-dropped: Step no longer reaches GeoscapeView.LaunchMission, so " +
                             "nothing opens the squad screen at all and every arm above is about a watch with no " +
                             "outcome.";
